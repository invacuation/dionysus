...
def _client_with_session_factory(
    ...
    *,
    ...
    overrides = settings.model_dump() if settings is not None else {}
    overrides.pop("database_url", None)
    app = create_prepared_test_app(**overrides)
...
def test_api_trivy_preview_returns_detected_metadata_without_persistence(
    ...
    with engine.connect() as connection:
        ...
        assert response.json() == {
            ...
            "detected_project_name": "api",
            "detected_asset_name": "2026.05.07",
